        ...
        <header className="shadow-sm">
            <div className="navbar bg-base-100 w-11/12 mx-auto">
                ...
                <div className="navbar-start">
                    ...
                    {/* Title and Logo */}
                    <Link to="/" className="flex justify-center items-center gap-2 text-lg md:text-2xl font-bold">
                        <img src={logo} alt="Job Hunt Sync" className="h-7 md:h-12 w-7 md:w-12" />
