        ...
        loginUser(email, password)
            .then((result) => {
                ...
                result.user.getIdToken().then((token) => {
                    axios.patch(`${import.meta.env.VITE_API_URL}/users/login`, signInInfo, {
                        headers: {
                ...
                <div className="modal-box">
                    ...
                    <form onSubmit={handleSubmit}>
                        <fieldset className="space-y-1.5">
                            ...
                            {/* Submit Button */}
                            <div>
                                <button type="submit" className="btn bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-primary text-white text-base w-full">Login your Account</button>
                            </div>
