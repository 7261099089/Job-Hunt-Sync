            ...
            <div className='modal-box'>
                ...
                <form onSubmit={handleSubmit}>
                    <fieldset className="space-y-1.5">
                        ...
                        {/* Submit Button */}
                        <div>
                            <button type="submit" className="btn bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-primary text-white hover:btn-secondary w-full">Reset password</button>
                        </div>
                    </fieldset>
                </form>
            </div>
